...
For this exercise you'll use precinct-level data from the 2016 presidental election to visualize relationships between variables. This data comes from the [MIT Election Data and Science Lab](https://dataverse.harvard.edu/dataset.xhtml?persistentId=doi:10.7910/DVN/VOQCHQ).
...
- [<i class="fab fa-r-project"></i> `07-exercise.Rmd`](/projects/06-exercise/07-exercise.Rmd)
